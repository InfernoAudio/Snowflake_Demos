...
CREATE STREAMLIT NOAA_WEATHER_STATIONS_PAGINATION
    ROOT_LOCATION = '@STREAMLIT_DB.STREAMLIT_STAGES.STG_NOAA_WEATHER'
    MAIN_FILE = 'noaa_weather_stations_pagination.py'
...
GRANT USAGE ON STREAMLIT NOAA_WEATHER_STATIONS_PAGINATION TO ROLE ST_APP_USERS;